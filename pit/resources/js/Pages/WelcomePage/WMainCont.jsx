                    ...
                    <div className="relative z-10 fade-rise h-full w-full lg:w-1/2 mt-32">
                        <div className="py-8 px-10 grid grid-cols-4 gap-2"> {/* Adjusted gap */}
                            <div className="h-64 col-span-4 sm:col-span-4 relative">
                                <img className="rounded-md absolute inset-0 h-full w-full" src="https://i.ibb.co/jTV4Qzq/rules.png?fbclid=IwZXh0bgNhZW0CMTAAAR3OVq1iYRYLVjZtOUcM16N_7ChuCXdLABQY6cKxaUVX_7CXvlxC-Ea0HJQ_aem_ZmFrZWR1bW15MTZieXRlcw" alt="IT" />
                            </div>

    ...
    <main className="w-full ml-5">
      ...
      <div className="bg-white p-5 shadow overflow-hidden sm:rounded-xl mr-8">
          <div className="ml-8 mr-8 flex flex-col items-center justify-center">
            ...
            <p className="mt-5 mb-5 w-100 py-[10px] flex items-center justify-center text-base font-semibold p-2 rounded-full bg-white text-indigo-700">
            ...
            <span className="ml-2 ">Check your email to view and download CoR</span>
              </p>

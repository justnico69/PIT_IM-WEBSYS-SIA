        ...
        <div className="w-full ml-5">
            ...
            <div className="grid grid-cols-4 grid-rows-12 gap-5 mr-8">
                ...
                <div className="row-span-3 col-span-2 bg-white rounded-xl shadow-lg flex items-center justify-center min-h-[100px]">
                    <a
                        href="#"
                        className={`text-blue-600 hover:text-blue-900 flex items-center justify-center w-full h-full transition-transform transform ${activeLink === 'confirmed' ? 'scale-105' : ''}`}
                        onClick={() => handleLinkClick('confirmed')}
                    >
                        <span className="material-icons-outlined focus:outline-none" style={{ fontSize: '2rem' }}>
                            <svg xmlns="http://www.w3.org/2000/svg" className="size-5" height="16" fill="currentColor" viewBox="0 0 16 16">
                ...
                <div className="row-span-3 col-span-2 bg-white rounded-xl shadow-lg flex items-center justify-center min-h-[100px]">
                    <a
                        href="#"
                        className={`text-blue-600 hover:text-blue-900 flex items-center justify-center w-full h-full transition-transform transform ${activeLink === 'pending' ? 'scale-105' : ''}`}

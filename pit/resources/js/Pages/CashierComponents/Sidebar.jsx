            ...
            <div className="flex flex-col justify-between flex-1 ml-3 mt-14">
                <nav className="-mx-3 space-y-6">
                    <div className="space-y-3">
                        <div id="sidebarGradient" className="bg-white rounded-xl shadow-lg mt-20 mb-6 ml-5 mr-5 h-[628px] py-4">
                            <a href="cashier-profile" className="text-blue-800 hover:text-blue-600 my-4 w-full flex flex-col items-center justify-center">
                                ...
                                <span className="mt-5 px-3 font-bold mb-4 text-center text-xl">Welcome, Cashier!</span>
                            </a>
                            <div className="mt-10 px-2 text-blue-600 text-lg font-semibold">
                                <a href="cashier-dashboard" className="flex items-center space-x-1 rounded-md mx-4 px-2 py-2 hover:bg-blue-500 hover:text-white">

                    ...
                    <div className="space-y-3">
                        <div id="sidebarGradient" className="bg-white rounded-xl shadow-lg mt-20 mb-6 ml-5 mr-5 h-[535px] py-4">
                            ...
                            <div className="mt-10 px-2 text-blue-600 text-lg font-semibold">
                                ...
                                <a href="new-en-stud" className="flex items-center space-x-1 rounded-md mx-4 px-2 py-2 hover:bg-blue-500 hover:text-white">
                                    <span className="bg-transparent p-0.5 transition-all duration-300 inline-flex items-center">
                                        <span className="material-icons-outlined">
                                        ...
                                        <span className="ml-2">Newly Enrolled Students</span>
                                    </span>
                                </a>

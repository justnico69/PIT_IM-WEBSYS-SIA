function AdMain() {
  return (
    <div className="w-full ml-5 h-screen overflow-hidden mt-5"> {/* Ensure h-screen and overflow-hidden are applied */}
      ...
      <div className="grid grid-cols-3 mb-2">
        ...
        <div className="mt-10 ml-2">
          <p className="text-large font-extrabold text-white">Student Status</p>
        </div>
      </div>

      <div className="grid grid-cols-2 gap-1">
        {/* Accepted Applicants */}
        <div className="h-[250px]  mr-10 mt-2 col-span-1 bg-white rounded-xl shadow-lg flex items-center justify-center">
        ...
        <div className="h-[250px] mt-2 mr-10 col-span-1 bg-white rounded-xl shadow-lg flex items-center justify-center">

...
const MainContent = () => {
    ...
    return (
        <div className="w-full ml-5">
            ...
            <div className={`row-span-2 col-span-4 bg-white rounded-xl shadow-lg flex items-center justify-center 
                            ${activeLink === 'scm-department' ? 'border-4 border-blue-500 transform translate-y-4' : ''}
                            ${activeLink ? 'transition-transform duration-300' : ''}`}>
                <a href="scm-department" className="text-blue-600 hover:text-blue-800 flex items-center justify-center w-full h-full"
                    onClick={() => handleLinkClick('scm-department')}>
                ...
                <div className={`row-span-2 col-span-2 bg-white rounded-xl shadow-lg flex items-center justify-center 
                        ${activeLink === 'it-department' ? 'border-4 border-blue-500 transform translate-y-4' : ''}
                        ${activeLink ? 'transition-transform duration-300' : ''}`}>
                    <a href="it-department" className="text-blue-600 hover:text-blue-800 flex items-center justify-center w-full h-full"
                        onClick={() => handleLinkClick('it-department')}>
                        <span className="material-icons-outlined focus:outline-none" style={{ fontSize: '2rem' }}>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6">
                ...
                <div className={`row-span-2 col-span-2 bg-white rounded-xl shadow-lg flex items-center justify-center min-h-[100px]
                        ${activeLink === 'tcm-department' ? 'border-4 border-blue-500 transform translate-y-4' : ''}
                        ${activeLink ? 'transition-transform duration-300' : ''}`}>
                    <a href="tcm-department" className="text-blue-600 hover:text-blue-800 flex items-center justify-center w-full h-full"
                        onClick={() => handleLinkClick('tcm-department')}>
                        <span className="material-icons-outlined focus:outline-none" style={{ fontSize: '2rem' }}>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6">

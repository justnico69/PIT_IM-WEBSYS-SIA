...
function DsMainCont() {
  ...
  return (
    <main className="w-full ml-5">
       <Head title="Data Science" />
      <ToastContainer />
      <div className="flex flex-row">
        <div className="row-span-3 col-span-4 items-center bg-white rounded-xl shadow-lg px-6 py-4 mt-[140px] mr-8 flex-grow">
          <p className="text-3xl mt-3 font-extrabold font-poppins text-blue-800">Data Science Enrollees</p>
          <p className="mt-3 mb-3 text-base font-semibold text-blue-800">List of enrolled Data Science students</p>
        </div>
      </div>
